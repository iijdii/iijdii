...
<div class="card p0">
    ...
    <div class="card-b">
        @if ($projekt->aufmassBestaetigt())
            ...
            <p class="hint" style="margin-top:8px">Erzeugt zwei Entwürfe: <b>Konstruktion</b> — die Überdachung als
                eine Position mit allen Bauteilen und Zuschnittlängen — und <b>Glas</b> für das Dach (eigener
                Lieferant). Erneuter Klick baut beide aus den aktuellen Daten neu auf.</p>
            ...
            @if ($endmassPositionen->isNotEmpty())
                ...
                <p class="hint" style="margin-top:8px">{{ $endmassPositionen->count() }} Position(en) mit
                    Endmaßen vom Monteur — je Lieferant ein Entwurf: Glas &amp; Schiebe (Wände, Keile,
                    Schiebeanlagen), Markisen, Sonnensegel.</p>
            @endif
        @else
