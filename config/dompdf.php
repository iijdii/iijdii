...
return [
    ...
    */
    ...
    'options' => [
         ...
         *
         * LEA: dompdf schreibt JEDES data:-URI-Bild (Logo, Skizzen, QR)
         * über tempnam() hierhin. Auf Shared Hosting (InfinityFree) liegt
         * sys_get_temp_dir() außerhalb von open_basedir — tempnam schlägt
         * fehl und die Bilder fehlen im PDF. Deshalb fest in den immer
         * beschreibbaren Laravel-Cache-Ordner legen.
         */
